                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="Page-addstock.php" class="btn btn-info"><i class="fa fa-plus"></i> Add Subject</a></li>
                            <li><a href="page-management.php" class="btn btn-info"><i class="fa fa-folder-open"></i>View Subjects</a></li>
                            <li> <a href="page-itemscategory.php" class="btn btn-info"><i class="fa-gear(alias)"></i>Allocation Report </a> </li>
